...
silent only
cd /mnt/e/TWORK/web--/clonek/goblog
...
badd +1 src/components/Blog.css
badd +41 src/components/errorpage.js
badd +18 src/components/common/uiCard.js
badd +5 src/components/common/UiButton.js
badd +5 src/index.css
badd +14 package.json
badd +20 public/index.html
badd +1 src/dracula.css
badd +1 src/index.js
argglobal
%argdel
$argadd src/App.js
set stal=2
edit src/components/common/uiCard.js
...
setlocal fen
silent! normal! zE
let s:l = 35 - ((0 * winheight(0) + 20) / 41)
